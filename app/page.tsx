...
export default function Home() {
  ...
  return (
    <React.Suspense fallback={<>Loading...</>}>
      <View width="100%" maxWidth="50rem" className="p-0 lg:p-8">
        <Card variation="outlined">
          <Flex className="flex-col lg:flex-row" justifyContent="space-evenly">
            ...
            <Flex direction="column" justifyContent="space-between">
              <Flex direction="column" gap="0.7rem">
                ...
                <Flex className="flex-col lg:flex-row" alignItems="baseline">
                  <Rating
